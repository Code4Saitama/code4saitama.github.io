...
SLIDER_ITEMS = [
    ...
    ("cfs-image-0189", "2015.02.21", "オープンデータもくもく会／インターナショナル・オープンデータ・デイ2015", "ハッカソンの続きを持ち寄り、オープンデータの活用を参加者それぞれが進めたもくもく会です。", "2015.02.21"),
    ("cfs-image-0046", "2015.09.05", "オープンデータアイデアソン2015", "地域を見つめ、データを使った解決策を考えた活動の記録です。", "2015.09.05"),
    ("cfs-image-0059", "2015.11.07", "池袋マッピングパーティー", "街歩きの実践とともに、OpenStreetMapを使ったマッピングパーティーの進め方を共有しました。", "2015.11.07"),
...
TOP_SLIDE_IDS = {
    ...
    "cfs-image-0189", "cfs-image-0059", "cfs-image-0212", "cfs-image-0216", "cfs-image-0222", "cfs-image-0067",
